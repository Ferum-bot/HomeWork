...
template<typename T, typename... Args>
constexpr bool is_nothrow_constructible_impl_v = is_nothrow_constructible_impl::value;
...
template<typename T>
struct is_nothrow_move_constructible: public is_nothrow_constructible<T, typename add_rvalue_reference_t<T> {  };

template<typename T>
constexpr bool is_nothrow_move_constructible_v = is_nothrow_move_constructible::value;